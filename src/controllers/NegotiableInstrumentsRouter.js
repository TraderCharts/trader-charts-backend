...
import { getOffsetByQuery, getLimit, getOffset } from './_helpersControllers/URLQueryHelpers';
...
class NegotiableInstrumentsRouter {
  ...
  getNegotiableInstruments = async (req, res) => {
    ...
    let negotiableInstruments = await this._negotiableInstrument.getNegotiableInstruments(
      { offset, limit },
      sort,
      query
    );
