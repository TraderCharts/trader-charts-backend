...
class UsersRouter {
    ...
    getUsers = async (req, res) => {
        ...
        const users = await this._user.getUsers(res, { offset, limit }, sort, query);
    ...
    postUser = async (req, res) => {
        ...
        const createdUser = await this._user.createUser(body);
    ...
    patchUser = async (req, res) => {
        ...
        const id = req.params.id;
        const body = req.body;
        const updatedUser = await this._user.updateUser(id, body);
    ...
    deleteUser = async (req, res) => {
        ...
        const id = req.params.id;
        const deletedUser = await this._user.deleteUser(id);
