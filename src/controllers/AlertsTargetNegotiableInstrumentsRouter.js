...
import {
  createAlertsTargetNegotiableInstrument,
  getAlertsTargetNegotiableInstruments,
} from '../managers/mongodb/AlertsTargetNegotiableInstruments';
...
class AlertsTargetNegotiableInstrumentsRouter {
  ...
  postAlertsTargetNegotiableInstruments = async (req, res) => {
    ...
    const newAlertsTargetNegotiableInstrument =
      await this._alertsTargetNegotiableInstrument.createAlertsTargetNegotiableInstrument(data);
